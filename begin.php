  ...
  <div clas="container">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <h2 class="byline mt-5 ankit" id="byline">CODOCRUX</h2>
      </div>
  ...
  <div clas="container">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <button onclick="contest_begin()" data-placement="top" data-toggle="tooltip" title="See you on 8th October 9:00pm!" class=" sarthak mt-5 text-center btn btn-md btn-outline-success">START </button>
