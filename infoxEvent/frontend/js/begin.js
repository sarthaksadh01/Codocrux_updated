...
function contest_begin(){
  ...
  var s = new Date("oct 8, 2018 18:00:00").getTime();
  var e  = new Date("oct 8, 2018 19:35:00").getTime();
  ...
  if(now>=s && now<=e){
    ...
    alert("Contest will start at : Oct 08, 2018 18:00 ");
  }
...
var countDownDate = new Date("oct 08, 2018 18:00:00").getTime();
